...
public class ColumnDataGeneratorAdapter implements ColumnGeneratorAdapter, InitializingBean {
	...
	@Override
	public ColumnData generateColumnData(long volumeId, String columnCode, List<FilterColumn> filterColumns, int pageNum, int pageSize) {
		...
		DataColumn dataColumn = volumeRepository.findDataColumn(volumeId, columnCode);
